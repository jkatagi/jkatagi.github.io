module.exports = {
    ...
    themeConfig: {
        nav: [
            ...
            {
                text: 'Contents', items: [
                    { text: 'Google Earth Engine入門-ゼロから始める衛星画像解析-', link: '/contents/google_earth_engine/' },
                    { text: 'About research in college', link: '/contents/about_research_in_college/' },
                ]
            },
        ...
        sidebar: {
            '/contents/google_earth_engine/': [
                {
                    title: 'Google Earth Engine入門-ゼロから始める衛星画像解析-',
                    collapsable: false,
                    children: [
